...
export default function Navbar() {
  ...
  return (
    <nav className="flex w-full items-center justify-between py-7 px-10 lg:px-32 bg-white text-slate-600 text-sm shadow-md sticky bottom-10 left-0 right-0 z-50">
